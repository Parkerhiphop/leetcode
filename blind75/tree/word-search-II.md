# [212. Word Searchx](https://leetcode.com/problems/word-search-ii/)

## [Solution: ADVANCED OPTIMIZATION(100%) with Pruning](https://leetcode.com/problems/word-search-ii/discuss/1178002/JS-Pruning-ADVANCED-OPTIMIZATION-(100))
...
var findWords = function(board, words) {
  ...
  function dfs(r, c, node) {
    // whether the current node is a word in our trie. (it can be 0 or 1)
    let numFound1 = 0;
    ...
    // how many more words we found doing dfs from the current node. (it can be >= 0)
    let numFound2 = 0;
